...
def upload_file():
    ...
    if file:
        ...
        # Use a more reliable path to the script
        analyzer_script_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'analyze.py')
        ...
        # Add the task to the dictionary immediately
